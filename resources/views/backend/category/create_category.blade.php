    ...
    <div class="content-wrapper">
        ...
        <div class="content-header mb-3 pb-2" style="background: white;">
            <div class="container-fluid" style="line-height: 0.6;">
                <div class="row mx-2">
                    <div class="col-sm-6">
                        <h1  style="line-height: 1;">Add New Category</h1>
                        <span class="font-italic">Add/Category</span>
                    </div>
                    <div class="col-sm-6 text-right mt-2">
                        <a class="btn btn-info btn-sm "  href="{{ route('category.index') }}" data-title="Category List"><i class="bi bi-list-task "></i> Category List</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <section class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body pt-1">
                                @include('backend.category.create_category_form')
                            </div>
                        </div>
                    </section>
                </div>
