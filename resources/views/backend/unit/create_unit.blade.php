    ...
    <div class="content-wrapper">
        ...
        <div class="content-header mb-3 pb-2" style="background: white;">
            <div class="container-fluid" style="line-height: 0.6;">
                <div class="row mx-2">
                    <div class="col-sm-6">
                        <h1  style="line-height: 1;">Add New Unit</h1>
                        <span class="font-italic">Add/Unit</span>
                    </div>
                    <div class="col-sm-6 text-right mt-2">
                        <a class="btn btn-info btn-sm "  href="{{ route('unit.index') }}" data-title="Unit List"><i class="bi bi-list-task "></i> Unit List</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <section class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body pt-1">
                                @include('backend.unit.create_unit_form')
                            </div>
                        </div>
                    </section>
                </div>
